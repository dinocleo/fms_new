        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="page-content-wrapper bg-white p-30 radius-20">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 col-xl-6">
                            <div class="dashboard-feature-item bg-off-white theme-border radius-4 p-15 mb-15"
                                ...
                                <div>
                                    <canvas id="utilitiesChart" style="height: 290px;"></canvas> <!-- Height added here -->
                                </div>
                                <div>
                        ...
                        <!-- Assets Management Summary (Right) -->
                        <div class="col-12 col-lg-6 col-xl-6">
                            <div class="dashboard-feature-item bg-off-white theme-border radius-4 p-15 mb-15"
                                style="border: 1px solid #ddd; padding: 15px; border-radius: 4px; background: #f9f9f9;">
                                <div>
                    ...
                    <div class="row">
                        <!-- Property & Assets Maintenance Summary (Left) -->
                        <div class="col-12 col-lg-6 col-xl-6">
                            <div class="dashboard-feature-item bg-off-white theme-border radius-4 p-15 mb-15"
                                style="border: 1px solid #ddd; padding: 15px; border-radius: 4px; background: #f9f9f9;">
                                {{-- <div
                        ...
                        <!-- Project Management Summary (Right) -->
                        <div class="col-12 col-lg-6 col-xl-6">
                            <div class="dashboard-feature-item bg-off-white theme-border radius-4 p-15 mb-15"
                                style="border: 1px solid #ddd; padding: 15px; border-radius: 4px; background: #f9f9f9;">
                                {{-- <div
