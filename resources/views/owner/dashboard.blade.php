...
{{--                        </div>--}}
                        ...
                        <div class="col-12 col-lg-6 col-xl-6">
                            <div class="dashboard-feature-item bg-off-white theme-border radius-4 p-15 mb-15" style="border: 1px solid #ddd; padding: 15px; border-radius: 4px; background: #f9f9f9;">
                                ...
                                <div class="mt-2">
                                    <h4 class="mb-0">{{ __('Property & Assets Maintenance') }}</h4>
                                </div>
                                <div>
                        ...
                        <div class="col-12 col-lg-6 col-xl-6">
                            <div class="dashboard-feature-item bg-off-white theme-border radius-4 p-15 mb-15" style="border: 1px solid #ddd; padding: 15px; border-radius: 4px; background: #f9f9f9;">
                                ...
                                <div class="mt-2">
                                    <h4 class="mb-0">{{ __('Project Management') }}</h4>
                                </div>
                                <div>
                    ...
                    datasets: [
                        {
                            ...
                            data: [234000, 256779, 389999, 289378, 367377.5, 397312.9, 427248.3, 457183.7, 487119.1, 517054.5, 546989.9, 576925.3],
                            borderColor: 'blue',
                            borderWidth: 2,
                            fill: false
                        },
                        {
                            label: 'Fuel Usage',
                            data: [200000, 230000, 150000, 200000, 230000, 150000, 173333.33, 167619.0476, 161904.7619, 156190.4762, 150476.1905, 144761.9048],
                            borderColor: 'orange',
                            borderWidth: 2,
                            fill: false
                        },
                        {
                            label: 'Water Usage',
                            data: [100000, 110000, 120000, 100000, 110000, 120000, 100000, 110000, 120000, 100000, 110000, 120000],
                            borderColor: 'gray',
                            borderWidth: 2,
                            fill: false
                        }
