                                ...
                                <table id="allMaintenanceDataTable" class="table bg-off-white aaa theme-border dt-responsive">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('Monthy Recurring') }}</th>
                                            <th>{{ __('General Recurring') }}</th>
                                            <th>{{ __('Status') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@if($item->MaintenanceIssue!=null)
                                            
                                            {{ $item->MaintenanceIssue->name }}


                                            @endif</td>
                                        <td>
                                            @if($item->multiple_date!=null)
...
{{-- 
                                        ...
                                        <td>
                                            ...
                                            @if($item->monthly_recurring!=null)
                                        ...
                                        <td>
                                            ...
                                            @if($item->general_recurring!=null)
                                            
                                            {{ $item->general_recurring }}
...
<script>
    ...
    <script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
    <script src="{{ asset('assets/js/custom/preventive-maintenance-request.js') }}"></script>
