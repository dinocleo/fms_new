                                    ...
                                    <div id="msform">
                                        ...
                                        <div class="stepper-progressbar-wrap radius-10 theme-border p-25 mb-25">
                                            <ul id="progressbar" class="text-center">
                                                ...
                                                <li class="{{ request()->routeIs('owner.property.nonCommercial') ? 'active' : '' }}">
                                                    <a href="{{ route('owner.property.nonCommercial') }}">
                                                        <span class="form-stepper-nav-icon"><i class="ri-home-4-fill"></i></span>
                                                        <span>{{ __('Property Information') }}</span>
                                                    </a>
                                                </li>
                                        
                                                @php
                                                    $propertyId = request()->route('propertyId') ?? request()->route('id'); // Get the property ID from the route
                                                @endphp
                                        
                                                <!-- Unit Step (Requires propertyId) -->
                                                <li class="{{ request()->routeIs('owner.property.unit') ? 'active' : '' }}">
                                                    @if($propertyId)
                                                        <a href="{{ route('owner.property.unit', ['propertyId' => $propertyId]) }}">
                                                            <span class="form-stepper-nav-icon"><i class="ri-layout-4-fill"></i></span>
                                                            <span>{{ __('Unit') }}</span>
                                                        </a>
                                                    @else
                                                        <span class="form-stepper-nav-icon"><i class="ri-layout-4-fill"></i></span>
                                                ...
                                                <li class="{{ request()->routeIs('owner.property.subUnits') ? 'active' : '' }}">
                                                    @if($propertyId)
                                                        <a href="{{ route('owner.property.subUnits', ['id' => $propertyId]) }}">
                                                            <span class="form-stepper-nav-icon"><i class="ri-map-pin-2-fill"></i></span>
