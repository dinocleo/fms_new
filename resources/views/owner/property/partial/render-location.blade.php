<form class="ajax" action="{{ route('owner.property.location.store') }}" method="post" data-handler="stepChange">
        ...
        <div class="add-property-inner-box bg-white theme-border radius-4 p-20">
            <div class="row">
                <div class="col-md-4 mb-25">
                    ...
                    <input type="text" name="country_id" class="form-control" placeholder="{{ __('Country') }}"
                        value="{{ @$property->propertyDetail->country_id }}">
                </div>
                <div class="col-md-4 mb-25">
                    <label class="label-text-title color-heading font-medium mb-2">{{ __('State') }}</label>
                    <input type="text" name="state_id" class="form-control" placeholder="{{ __('State') }}"
                        value="{{ @$property->propertyDetail->state_id }}">
                </div>
                <div class="col-md-4 mb-25">
                    <label class="label-text-title color-heading font-medium mb-2">{{ __('City') }}</label>
                    <input type="text" name="city_id" class="form-control" placeholder="{{ __('City') }}"
                        value="{{ @$property->propertyDetail->city_id }}">
                </div>
            </div>
            <div class="row">
                {{-- <div class="col-md-4 mb-25">
    ...
    <input type="button" name="previous" class="locationBack action-button-previous theme-btn mt-25"
        value="{{ __('Back') }}">
