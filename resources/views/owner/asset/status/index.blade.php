                            ...
                            <div class="property-search-inner-bg bg-off-white theme-border radius-4 p-25 pb-0 mb-25">
                                <div class="row">
                                    <div class="col-xl-12 col-xxl-6 tenants-top-bar-left">
                                        <form action="{{ route('owner.assets.status.store') }}" method="POST">
                                            @csrf
                                            <div class="row">
                                            @if (getOption('app_card_data_show', 1) == 1)
                                                <div class="col-md-6 col-lg-6 col-xl-4 col-xxl-4 mb-25">
                                                    <input type="text" required class="form-control" name="name"  placeholder="Status Name">
                                                </div>
                                                            ...
                                                            @foreach ($list as $item)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('owner.assets.status.delete', [$item->id]) }}"
                                                                            method="post"
